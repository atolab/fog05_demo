...
def main(ip, fdufile, fdu2file,  n1, n2):
    ...
    a.fdu.stop(e2_uuid, n2, wait=True)
    a.fdu.stop(e_uuid, n1, wait=True)
    a.fdu.clean(e2_uuid, n2, wait=True)
    a.fdu.clean(e_uuid, n1, wait=True)
    a.fdu.undefine(e2_uuid, n2, wait=True)
